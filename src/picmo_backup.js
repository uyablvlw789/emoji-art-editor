...
var y = (i, e, t) => (U(i, e, "read from private field"), t ? t.call(i) : e.get(i)), f = (i, e, t) => {
  if (e.has(i))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(i) : e.set(i, t);
}, I = (i, e, t, o) => (U(i, e, "write to private field"), o ? o.call(i, t) : e.set(i, t), t);
var g = (i, e, t) => (U(i, e, "access private method"), t);
const Le = "14.0";
function Fe(i, e, t) {
  let o = `https://cdn.jsdelivr.net/npm/emojibase-data@${e}/${i}`;
  return typeof t == "function" ? o = t(i, e) : typeof t == "string" && (o = `${t}/${i}`), o;
}
async function re(i, e = {}) {
  const {
    ...
    cdnUrl: s,
    ...r
  } = e, a = Fe(i, o, s), n = t ? localStorage : sessionStorage, l = `emojibase/${o}/${i}`, m = n.getItem(l);
  if (m)
...
async function de(i, e, t) {
  var o;
  return re(`${i}/shortcodes/${(o = Ae[e]) !== null && o !== void 0 ? o : e}.json`, t);
}
function E(i, e) {
  if (e.length === 0)
    return i;
  ...
  }), i.shortcodes = [...t], i.skins && i.skins.forEach((o) => {
    E(o, e);
  }), i;
}
function Ie(i, e = []) {
...
async function be(i, e = {}) {
  const {
    ...
    shortcodes: s = [],
    ...r
  } = e, a = await re(`${i}/${t ? "compact" : "data"}.json`, r);
  let n = [];
...
function De(i) {
  const { emojisUrl: e, messagesUrl: t } = Be("latest", i);
  try {
    return Promise.all([
      pe(e),
      pe(t)
...
async function Ne(i, e, t) {
  ...
  if (t !== r || e !== s) {
    const [a, n] = await Promise.all([Ce(i.locale), be(i.locale)]);
    await i.populate({
      groups: a.groups,
      emojis: n,
      emojisEtag: e,
...
async function Oe(i, e, t) {
  const o = await je(i, e, t), [s, r] = await De(i);
  if (await o.isPopulated())
    s && r && await Ne(o, s, r);
  else {
    const [a, n] = await Promise.all([Ce(i), be(i)]);
    await o.populate({ groups: a.groups, emojis: n, emojisEtag: s, messagesEtag: r });
  }
  return o;
}
async function Ue(i, e, t, o, s) {
  const r = await je(i, e, s), a = await Me(o);
  return (!await r.isPopulated() || await He(r, a)) && await r.populate({ groups: t.groups, emojis: o, hash: a }), r;
}
async function ne(i, e, t, o, s) {
  return t && o ? Ue(i, e, t, o, s) : Oe(i, e, s);
}
function zi(i, e) {
  i.deleteDatabase(e);
}
...
function lt(i, e) {
  const t = Q(e);
  return t.dataset.icon = i, t.classList.add(ae("icon")), t;
}
const ue = {
  clock: Ge,
  flag: We,
...
b = new WeakMap(), S = new WeakMap(), P = new WeakSet(), X = async function(e, t) {
  const o = e.querySelectorAll("[data-view]"), s = [];
  for (const r of o) {
...
class gt {
  ...
  renderImage(e = "", t) {
    const o = new pt({ classNames: e });
    return o.renderSync(), { content: o, resolver: () => (o.load(t()), o.el) };
  }
  doRender(e, t, o) {
    if (e.custom)
      return this.renderCustom(e, t, o);
    const { content: s, resolver: r } = this.render(e, o), a = s instanceof Element ? s : s.el;
    return r && r(), a;
  }
  doEmit(e) {
  ...
  renderCustom(e, t, o = "") {
    const s = [ut.customEmoji, o].join(" ").trim(), { content: r, resolver: a } = this.renderImage(s, () => e.url), n = r instanceof Element ? r : r.el;
    return a && a(), n;
  }
}
const yt = new p(({ emoji: i }) => `<span>${i}</span>`);
class ft extends gt {
  render(e) {
...
function bt(i, e) {
  return wt.some((t) => t(i, e) === null) ? null : i;
}
function B(i, e) {
  return i.filter((t) => bt(t, e) !== null);
}
function x(i) {
  var e;
  return {
    ...
    label: i.label,
    tags: i.tags,
    skins: (e = i.skins) == null ? void 0 : e.map((t) => x(t)),
    order: i.order,
    custom: !1,
    hexcode: i.hexcode,
    version: i.version
...
function D(i, e, t) {
  var o;
  return t && !t.some((s) => s.order === i.group) ? !1 : me(i.label, e) || ((o = i.tags) == null ? void 0 : o.some((s) => me(s, e)));
}
class Ee {
  constructor(e = "en") {
    this.locale = e;
...
xe.deleteDatabase = (i) => new Promise((e, t) => {
  const o = indexedDB.deleteDatabase(`${te}-${i}`);
...
class Ct extends Ee {
  async open() {
    ...
    return new Promise((t, o) => {
      ...
      }), e.addEventListener("error", o), e.addEventListener("upgradeneeded", async (s) => {
        var a;
  ...
  async getEtags() {
    const t = this.db.transaction("meta", "readonly").objectStore("meta"), [o, s] = await Promise.all([
  ...
  async searchEmojis(e, t, o, s) {
    ...
    return new Promise((a, n) => {
      ...
      d.addEventListener("success", (h) => {
        ...
        const O = H.value;
        D(O, e, s) && O.version <= o && r.push(x(O)), H.continue();
  ...
  async removeAllObjects(...e) {
    const t = this.db.transaction(e, "readwrite"), o = e.map((s) => t.objectStore(s));
...
class Se extends _t {
  ...
  addOrUpdateRecent(e, t) {
    ...
    try {
      this.storage.setItem(q, JSON.stringify(o));
    } catch {
...
function Et(i = {}) {
  return {
    ...kt,
    ...i,
    renderer: i.renderer || new ft(),
    recentsProvider: i.recentsProvider || new jt()
  };
}
var v, C, M, L, ie;
class ce {
  ...
  on(e, t, o) {
    g(this, L, ie).call(this, e, t, o);
  }
  once(e, t, o) {
    g(this, L, ie).call(this, e, t, o, !0);
  }
  off(e, t) {
    const o = g(this, C, M).call(this, e);
    y(this, v).set(e, o.filter((s) => s.handler !== t));
  }
  emit(e, ...t) {
...
}, L = new WeakSet(), ie = function(e, t, o, s = !1) {
  g(this, C, M).call(this, e).push({ context: o, handler: t, once: s });
};
const xt = {
  injectStyles: !0
};
...
class le extends c {
  constructor({ template: e, category: t, showVariants: o, lazyLoader: s }) {
    super({ template: e, classes: oe }), this.baseUIElements = {
      categoryName: c.byClass(oe.categoryName)
    }, this.category = t, this.showVariants = o, this.lazyLoader = s;
  }
  setActive(e, t, o) {
    this.emojiContainer.setActive(e, t, o);
  }
}
const zt = new p(({ classes: i, emoji: e }) => `
  <button
    type="button"
    class="${i.emojiButton}"
    title="${e.label}"
...
class Pe extends c {
  constructor({ emoji: e, lazyLoader: t, category: o }) {
    super({ template: zt, classes: $t }), this.emoji = e, this.lazyLoader = t, this.category = o;
  }
  initialize() {
    this.uiEvents = [
...
class Lt {
  constructor(e, t, o = 0, s = 0, r = !1) {
    ...
    }, this.rowCount = Math.ceil(t / e), this.columnCount = e, this.focusedRow = o, this.focusedColumn = s, this.emojiCount = t, this.wrap = r, this.handleKeyDown = this.handleKeyDown.bind(this);
  }
  destroy() {
  ...
  setCell(e, t, o = !0) {
    ...
    this.focusedRow = e, t !== void 0 && (this.focusedColumn = Math.min(this.columnCount, t)), (this.focusedRow >= this.rowCount || this.getIndex() >= this.emojiCount) && (this.focusedRow = this.rowCount - 1, this.focusedColumn = this.emojiCount % this.columnCount - 1), this.events.emit("focus:change", { from: s, to: this.getIndex(), performFocus: o });
  }
  setFocusedIndex(e, t = !0) {
    const o = Math.floor(e / this.columnCount), s = e % this.columnCount;
    this.setCell(o, s, t);
  }
  focusNext() {
...
const Ft = new p(({ classes: i }) => `
  <div class="${i.emojiContainer}">
    <div data-placeholder="emojis"></div>
  </div>
`), At = u("emojiContainer");
class A extends c {
  constructor({ emojis: e, showVariants: t, preview: o = !0, lazyLoader: s, category: r, fullHeight: a = !1 }) {
    super({ template: Ft, classes: At }), this.fullHeight = !1, this.showVariants = t, this.lazyLoader = s, this.preview = o, this.emojis = e, this.category = r, this.fullHeight = a, this.setFocus = this.setFocus.bind(this), this.triggerNextCategory = this.triggerNextCategory.bind(this), this.triggerPreviousCategory = this.triggerPreviousCategory.bind(this);
  }
  initialize() {
  ...
  setActive(e, t, o) {
    var s;
    e ? this.setFocusedView(t, o) : (s = this.emojiViews[this.grid.getIndex()]) == null || s.deactivateFocus();
  }
  renderSync() {
  ...
  setFocus({ from: e, to: t, performFocus: o }) {
    var s, r;
    (s = this.emojiViews[e]) == null || s.deactivateFocus(), (r = this.emojiViews[t]) == null || r.activateFocus(o);
  }
  selectEmoji(e) {
    e.stopPropagation();
  ...
  showPreview(e) {
    const o = e.target.closest("button"), s = o == null ? void 0 : o.firstElementChild, r = K(e, this.emojis);
...
const It = new p(({ classes: i, category: e, pickerId: t, icon: o, i18n: s }) => `
...
`);
class Tt extends le {
  constructor({ category: e, showVariants: t, lazyLoader: o, emojiVersion: s }) {
    super({ category: e, showVariants: t, lazyLoader: o, template: It }), this.showVariants = t, this.lazyLoader = o, this.emojiVersion = s;
  }
  initialize() {
...
class Rt extends A {
  constructor({ category: e, emojis: t, preview: o = !0, lazyLoader: s }) {
    super({ category: e, emojis: t, showVariants: !1, preview: o, lazyLoader: s });
  }
  async addOrUpdate(e) {
    const t = this.el.querySelector(`[data-emoji="${e.emoji}"]`);
    t && (this.el.removeChild(t), this.emojis = this.emojis.filter((s) => s !== e));
    const o = this.viewFactory.create(Pe, { emoji: e });
...
const Vt = new p(({ emojiCount: i, classes: e, category: t, pickerId: o, icon: s, i18n: r }) => `
  <section class="${e.emojiCategory}" role="tabpanel" aria-labelledby="${o}-category-${t.key}">
    <h3 data-category="${t.key}" class="${e.categoryName}">
      <i data-icon="${s}"></i>
      ${translateText('#recentsText')}
    </h3>
    <div data-empty="${i === 0}" class="${e.recentEmojis}">
      <div data-view="emojis" data-render="sync"></div>
    </div>
    <div class="${e.noRecents}">
      ${translateText('#recentsDesc')}
    </div>
  </section>
`, { mode: "async" });
class Mt extends le {
  constructor({ category: e, lazyLoader: t, provider: o }) {
    super({ category: e, showVariants: !1, lazyLoader: t, template: Vt }), this.provider = o;
  }
  initialize() {
    this.uiElements = {
      ...this.baseUIElements,
      recents: c.byClass(oe.recentEmojis)
    }, this.appEvents = {
...
const Bt = new p(({ classes: i, category: e, pickerId: t, icon: o, i18n: s }) => `
  <section class="${i.emojiCategory}" role="tabpanel" aria-labelledby="${t}-category-${e.key}">
    <h3 data-category="${e.key}" class="${i.categoryName}">
      <i data-icon="${o}"></i>
      ${s.get(`categories.${e.key}`, e.message || e.key)}
  ...
  observe(e) {
    if (window.IntersectionObserver) {
      const t = new IntersectionObserver(
        (o) => {
          o.filter((s) => s.intersectionRatio > 0).map((s) => s.target).forEach((s) => {
...
const ge = u("emojiArea"), Nt = new p(({ classes: i }) => `
...
class Kt extends c {
  constructor({ categoryTabs: e, categories: t, emojiVersion: o }) {
    super({ template: Nt, classes: ge }), this.selectedCategory = 0, this.scrollListenerState = "active", this.lazyLoader = new ze(), this.categoryTabs = e, this.categories = t, this.emojiVersion = o, this.handleScroll = Re(this.handleScroll.bind(this), 100);
  }
  initialize() {
    this.appEvents = {
  ...
  async selectCategory(e, t = {}) {
    ...
    const { focus: o, performFocus: s, scroll: r } = {
      performFocus: !1,
      ...t
    };
    ...
    this.emojiCategories[a].setActive(!0, Ut(o), o !== "button" && s), r && (this.el.scrollTop = n), this.scrollListenerState = "resume";
  }
  ...
  handleScroll() {
    ...
    e === 0 ? this.categoryTabs.setActiveTab(0, s) : Math.floor(e) === Math.floor(t) || o < 0 ? this.categoryTabs.setActiveTab(this.categories.length - 1, s) : this.categoryTabs.setActiveTab(o, s);
  }
}
const qt = new p(({ classList: i, classes: e, icon: t, message: o }) => `
...
class se extends c {
  constructor({ message: e, icon: t = "warning", template: o = qt, className: s }) {
    super({ template: o, classes: ye }), this.message = e, this.icon = t, this.className = s;
  }
  renderSync() {
...
const Gt = new p(({ classList: i, classes: e, icon: t, i18n: o, message: s }) => `
  <div class="${i}" role="alert">
...
class Xt extends c {
  ...
  showPreview(e, t) {
    if (w(this.ui.emoji, t), this.ui.name.textContent = e.label, e.tags) {
      ...
      const o = e.tags.map((s) => Yt.renderSync({ tag: s, classes: _ }));
      w(this.ui.tagList, ...o);
    }
  }
  hidePreview() {
...
const Zt = new p(({ classes: i, i18n: e }) => `
  <button title="${e.get("search.clear")}" class="${i.clearSearchButton}">
    <i data-icon="xmark"></i>
  </button>
`), ei = new p(({ classes: i, i18n: e }) => `
<div class="${i.searchContainer}">
  <input class="${i.searchField}" placeholder="${translateText('#searchText')}">
...
class ti extends c {
  constructor({ categories: e, emojiVersion: t }) {
    super({ template: ei, classes: j }), this.categories = e.filter((o) => o.key !== "recents"), this.emojiVersion = t, this.search = Ve(this.search.bind(this), 100);
  }
  initialize() {
    this.uiElements = {
      ...
      try {
        ...
        if (this.events.emit("preview:hide"), t.length) {
          ...
          this.resultsContainer = this.viewFactory.create(A, {
            ...
            showVariants: !0,
            lazyLoader: o
          }), this.resultsContainer.renderSync(), (e = this.resultsContainer) != null && e.el && (o.observe(this.resultsContainer.el), this.resultsContainer.setActive(!0, { row: 0, offset: 0 }, !1), this.resultsContainer.el.addEventListener("keydown", (s) => this.handleResultsKeydown(s)), this.events.emit("content:show", this.resultsContainer));
        } else
...
class oi extends c {
  constructor({ emoji: e, parent: t }) {
    super({ template: ii, classes: fe, parent: t }), this.focusedEmojiIndex = 0, this.focusTrap = new Ke(), this.animateShow = () => Promise.all([
...
const si = new p(({ classes: i, i18n: e, category: t, pickerId: o, icon: s }) => `
<li class="${i.categoryTab}">
  <button
    ...
    data-id="${t.key}"
    tabindex="-1"
    title="${t.key == 'recents'?translateText('#recentsNav'):e.get(`categories.${t.key}`, t.message || t.key)}"
    type="button"
    data-category="${t.key}"
    id="${o}-category-${t.key}"
  >
...
class ri extends c {
  constructor({ category: e, icon: t }) {
    super({ template: si, classes: W }), this.isActive = !1, this.category = e, this.icon = t;
  }
  initialize() {
    this.uiElements = {
  ...
  setActive(e, t = {}) {
    const { changeFocusable: o, performFocus: s, scroll: r } = {
      changeFocusable: !0,
      performFocus: !0,
      scroll: !0,
      ...t
    };
    this.el.classList.toggle(W.categoryTabActive, e), o && (this.ui.button.tabIndex = e ? 0 : -1, this.ui.button.ariaSelected = e.toString()), e && s && (this.ui.button.focus(), r && this.events.emit("category:select", this.category.key, { scroll: "animate", focus: "button", performFocus: !1 })), this.isActive = e;
  }
  selectCategory() {
    this.isActive || this.events.emit("category:select", this.category.key, { scroll: "animate", focus: "button", performFocus: !0 });
  }
}
const ai = new p(({ classes: i }) => `
  <div class="${i.categoryButtonsContainer}">
    <ul role="tablist" class="${i.categoryButtons}">
      <div data-placeholder="tabs"></div>
    </ul>
  </div>
`), ni = u("categoryButtons", "categoryButtonsContainer");
class ci extends c {
  constructor({ categories: e }) {
    super({ template: ai, classes: ni }), this.activeCategoryIndex = 0, this.categories = e;
  }
  initialize() {
    this.keyBindings = {
  ...
  renderSync() {
    return this.tabViews = this.categories.map((e) => this.viewFactory.create(ri, { category: e, icon: N[e.key] })), super.renderSync({
  ...
  setActiveTab(e, t = {}) {
    this.checkOverflow();
    const o = this.currentTabView, s = this.tabViews[e];
    o.setActive(!1, t), s.setActive(!0, t), this.activeCategoryIndex = e;
  }
  getTargetCategory(e) {
...
function mi({ showHeader: i, classes: e }) {
  return i ? `
...
function ui(i) {
  const { emojiCount: e, classes: t, theme: o, className: s, categoryCount: r } = i, a = ({ showSearch: d, classes: h }) => d ? `
...
const gi = new p((i) => i.isLoaded ? pi(i) : ui(i)), k = u(
  "picker",
  "skeleton",
  "placeholder",
  "searchSkeleton",
...
class yi extends c {
  constructor() {
    super({ template: gi, classes: k }), this.pickerReady = !1, this.externalEvents = new Pt(), this.updaters = {
  ...
  buildChildViews() {
    return this.options.showPreview && (this.preview = this.viewFactory.create(Xt)), this.options.showSearch && (this.search = this.viewFactory.create(ti, {
      categories: this.categories,
      emojiVersion: this.emojiVersion
    })), this.options.showCategoryTabs && (this.categoryTabs = this.viewFactory.create(ci, {
      categories: this.categories
  ...
  onError(e) {
    const t = this.viewFactory.create(Jt, { message: this.i18n.get("error.load") }), o = this.el.offsetHeight || 375;
    throw this.el.style.height = `${o}px`, w(this.el, t.renderSync()), e;
  }
  async onDataReady(e) {
    const t = this.el;
    try {
      e ? this.emojiData = e : await this.emojiDataPromise, this.options.emojiVersion === "auto" ? this.emojiVersion = hi() || parseFloat(Le) : this.emojiVersion = this.options.emojiVersion, this.categories = await this.emojiData.getCategories(this.options);
  ...
  showContent(e = this.emojiArea) {
    var t, o;
    e !== this.currentView && (this.currentView !== this.emojiArea && ((t = this.currentView) == null || t.destroy()), this.ui.pickerContent.classList.toggle(k.fullHeight, e !== this.emojiArea), w(this.ui.pickerContent, e.el), this.currentView = e, e === this.emojiArea ? (this.emojiArea.reset(), this.categoryTabs && this.ui.header.appendChild(this.categoryTabs.el)) : (o = this.categoryTabs) == null || o.el.remove());
  }
  hideVariantPopup() {
    var e;
  ...
  isPickerClick(e) {
    var r, a;
    const t = e.target, o = this.el.contains(t), s = (a = (r = this.variantPopup) == null ? void 0 : r.el) == null ? void 0 : a.contains(t);
    return o || s;
  }
  ...
  async showVariantPopup(e) {
    ...
    this.events.once("variantPopup:hide", () => {
      t == null || t.focus();
    }), this.variantPopup = this.viewFactory.create(oi, { emoji: e, parent: this.el }), this.el.appendChild(this.variantPopup.renderSync()), this.variantPopup.activate();
  }
  async emitEmoji(e) {
...
class fi {
  constructor({ events: e, i18n: t, renderer: o, emojiData: s, options: r, customEmojis: a = [], pickerId: n }) {
    this.events = e, this.i18n = t, this.renderer = o, this.emojiData = s, this.options = r, this.customEmojis = a, this.pickerId = n;
  }
  setEmojiData(e) {
...
class Si extends Ee {
  ...
  getEmojis(e, t) {
    const o = this.emojis.filter((s) => s.group === e.order).filter((s) => s.version <= t).sort((s, r) => s.order != null && r.order != null ? s.order - r.order : 0).map(x);
...
async function Ii(i, e, t, o) {
  (await ne(i, e, t, o)).close();
}
export {
  yi as EmojiPicker,
  ce as Events,
  Ke as FocusTrap,
  xi as InMemoryStoreFactory,
  xe as IndexedDbStoreFactory,
  jt as LocalStorageProvider,
  ft as NativeRenderer,
  _t as RecentsProvider,
  gt as Renderer,
  Ai as SessionStorageProvider,
  T as animate,
  Li as autoTheme,
  me as caseInsensitiveIncludes,
  Me as computeHash,
  Ii as createDatabase,
  Fi as createPicker,
  bi as createStyleInjector,
  $i as darkTheme,
  Ve as debounce,
  zi as deleteDatabase,
  V as empty,
  vt as en,
